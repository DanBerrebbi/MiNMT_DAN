...
from transformer.Model_s_sc_s_scc import Encoder_Decoder_s_sc_s_scc
import numpy as np
...
if __name__ == '__main__':
  ...
  if o.net['model_type'] == 's_sc_s_scc':
    model = Encoder_Decoder_s_sc_s_scc(o.net['n_layers'], o.net['ff_dim'], o.net['n_heads'], o.net['emb_dim'], o.net['qk_dim'], o.net['v_dim'], o.net['dropout'], o.net['share_embeddings'], len(src_voc), len(tgt_voc), src_voc.idx_pad).to(device)
