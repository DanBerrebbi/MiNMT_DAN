...
if __name__ == '__main__':
  ...
  if n['model_type'] == 's_sc_s_scc':
    model = Encoder_Decoder_s_sc_s_scc(n['n_layers'], n['ff_dim'], n['n_heads'], n['emb_dim'], n['qk_dim'], n['v_dim'], n['dropout'], n['share_embeddings'], len(src_voc), len(tgt_voc), src_voc.idx_pad).to(device)
